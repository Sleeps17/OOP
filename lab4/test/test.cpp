...
TEST(TestRhomb, TestArea) {
    Point<double> upper(0.0, 1.0), lower(0.0, -1.0), left(-3.0, 0.0), right(3.0, 0.0);
    Rhomb<double> r = Rhomb<double>(upper, lower, left, right, "rhomb1");
    double ans_area = 6.0;
...
TEST(TestRhomb, TestPerimetr) {
    Point upper(0.0, 1.0), lower(0.0, -1.0), left(-3.0, 0.0), right(3.0, 0.0);
    Rhomb<double> r = Rhomb(upper, lower, left, right, "rhomb1");
...
TEST(TestRhomb, TestOperatorEqual) {
...
TEST(TestRhomb, TestOperatorNotEqual) {
  Point upper(1.0, 2.0), lower(1.0, -2.0), left(0.0, 0.0), right(2.0, 0.0);
    Rhomb r1(upper, lower, left, right, "rhomb1");
    Rhomb r2(upper, lower, left, right, "rhomb2");
    ASSERT_FALSE(r1 != r2); 
...
TEST(TestTrapezoid, TestArea) {
    Point left_lower(0.0, 0.0), right_lower(6.0, 0.0), left_upper(2.0, 2.0), right_upper(4.0, 2.0);
    Trapezoid<double> t = Trapezoid(left_lower, right_lower, left_upper, right_upper, "trapezoid");
...
TEST(TestTrapezoid, TestPerimetr) {
    Point left_lower(0.0, 0.0), right_lower(6.0, 0.0), left_upper(2.0, 2.0), right_upper(4.0, 2.0);
   Trapezoid<double>  t = Trapezoid(left_lower, right_lower, left_upper, right_upper, "trapezoid");
...
TEST(TestTrapezoid, TestOperatorEqual) {
    Point left_lower(0.0, 0.0), right_lower(6.0, 0.0), left_upper(2.0, 2.0), right_upper(4.0, 2.0);
    Trapezoid<double> t = Trapezoid(left_lower, right_lower, left_upper, right_upper, "trapezoid");
...
TEST(TestTrapezoid, TestOperatorNotEqual) {
    Point left_lower(0.0, 0.0), right_lower(6.0, 0.0), left_upper(2.0, 2.0), right_upper(4.0, 2.0);
    Trapezoid<double> t = Trapezoid(left_lower, right_lower, left_upper, right_upper, "trapezoid");
    Trapezoid t2 = Trapezoid(left_lower, right_lower, left_upper, right_upper, "Trapezoid2");
    ASSERT_FALSE(t != t2);
...
TEST(TestTrapezoid, TestOperatorDouble) {
    Point left_lower(0.0, 0.0), right_lower(6.0, 0.0), left_upper(2.0, 2.0), right_upper(4.0, 2.0);
    Trapezoid<double> t = Trapezoid(left_lower, right_lower, left_upper, right_upper, "trapezoid");
    double ans = 10.338387;
...
TEST(TestPentagone, TestArea) {
    ...
    Pentagone<double> p = Pentagone(left_lower, right_lower, left_middle, right_middle, upper, "pent");

    double ans = 1.3140510000000001;
    EXPECT_FLOAT_EQ(p.area(), ans);

    left_lower = Point(1.0, 0.0); right_lower = Point(0.588, -0.809); left_middle = Point(-0.951, 0.309); right_middle = Point(0.951, 0.309); upper = Point(0.0, 1.0);
    p = Pentagone(left_lower, right_lower, left_middle, right_middle, upper, "pent");
    ans = 1.7350509999999999;
    EXPECT_FLOAT_EQ(p.area(), ans);
}

TEST(TestPentagone, TestPerimetr) {
    Point left_lower(0.0, 1.0), right_lower(0.951, 0.309), left_middle(0.588, -0.809), right_middle(-0.588, -0.809), upper(-0.951, 0.309);
    Pentagone<double> p = Pentagone(left_lower, right_lower, left_middle, right_middle, upper, "pent");
...
TEST(TestPentagone, TestOperatorEqual) {
    Point left_lower(0.0, 1.0), right_lower(0.951, 0.309), left_middle(0.588, -0.809), right_middle(-0.588, -0.809), upper(-0.951, 0.309);
    Pentagone<double>  p = Pentagone(left_lower, right_lower, left_middle, right_middle, upper, "pent");
...
TEST(TestPentagone, TestOperatorNotEqual) {
    Point left_lower(0.0, 1.0), right_lower(0.951, 0.309), left_middle(0.588, -0.809), right_middle(-0.588, -0.809), upper(-0.951, 0.309);
    Pentagone<double> p = Pentagone(left_lower, right_lower, left_middle, right_middle, upper, "pent");
    Pentagone p1 = Pentagone(left_lower, right_lower, left_middle, right_middle, upper, "p2");
    ASSERT_FALSE(p != p1);
